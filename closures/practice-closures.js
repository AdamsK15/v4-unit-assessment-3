...
function plantTracker(plant, height) {
  return {
    readInfo: function () {
...
function inventory() {
  ...
  return {
    ...
    addToProducts: function (param) {
      return products.push(param)
    },
    deleteFromProducts: function (param) {
      return delete products[param]
    }
  }
}
